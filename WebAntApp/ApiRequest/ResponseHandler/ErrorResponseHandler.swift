...
//           googleStorageHost.contains(host) {
...
//                        let error = violations.reduce("", { result, elem in
//                            result + elem.localizePropertyPath + ": " + (elem.message ?? "")
//                        })
//                        errorEntity.errors.append(!error.isEmpty ? error : responseError.detail)
//                    } else {
